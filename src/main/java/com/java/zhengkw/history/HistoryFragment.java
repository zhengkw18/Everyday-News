...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = root.findViewById(R.id.recyclerView_history);
        Context mContext = getContext();
        mAdapter = new HistoryFragment.HistoryAdapter(mContext, new ArrayList<News>(0));
    ...
    private class HistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public HistoryAdapter(Context _context, ArrayList<News> _newsList) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            if (viewType == 1) {
                ...
                RecyclerView.ViewHolder holder = new HistoryFragment.ItemViewHolder(view);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof HistoryFragment.ItemViewHolder) {
                News news = newsList.get(position);
                HistoryFragment.ItemViewHolder itemHolder = (HistoryFragment.ItemViewHolder) holder;
